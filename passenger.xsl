...
<body style="font-family:Arial;font-size:12pt;background-color:red">
<h1 style="color :black "><center>Passenger Details with XSLT</center></h1>
<xsl:for-each select="details/info">
  ...
  <div style="margin-left:20px;margin-bottom:1em;font-size:10pt">
    ...
    <span style="font-style:italic"> (<xsl:value-of select="aadhar"/>)</span>
    </p>
  </div>
</xsl:for-each>
